...
netsh advfirewall firewall add rule name="RDP-in" dir=in protocol=tcp remoteport=3389 action=allow remoteip=172.16.2.21
netsh advfirewall firewall add rule name="RDP-out" dir=out protocol=tcp remoteport=3389 action=allow remoteip=172.16.2.21

netsh advfirewall firewall add rule name="Windows Remote Management (HTTP-In)" dir=in protocol=tcp localport=5986 action=allow remoteip=172.16.128.154
netsh advfirewall firewall add rule name="Windows Remote Management (HTTP-Out)" dir=out protocol=tcp localport=5986 action=allow remoteip=172.16.128.154
