...
netsh advfirewall firewall add rule name="RDP" dir=in protocol=tcp localport=3389 action=allow remoteip=10.2.1.3
netsh advfirewall firewall add rule name="RDP" dir=out protocol=tcp localport=3389 action=allow remoteip=10.2.1.3
